      ...
      <div className="w-full max-w-5xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="order-2 lg:order-1 text-center lg:text-left">
            ...
            <p className="animate-fade-up [animation-delay:280ms]
          ...
          <div className="order-1 lg:order-2 flex justify-center">
            <div className="animate-float relative w-52 h-52 sm:w-64 sm:h-64 lg:w-72 lg:h-72">
              <div
                ...
                style={{ background: 'conic-gradient(#c9a96e 0deg,transparent 100deg,#e0bf85 200deg,transparent 300deg,#c9a96e 360deg)' }}
              />
              ...
              <span className="absolute -top-3 -right-3 bg-light-card dark:bg-dark-card
              ...
              <span className="absolute -bottom-2 -left-3 bg-light-card dark:bg-dark-card
                               border border-light-border dark:border-dark-border
                               rounded-lg px-3 py-1.5 font-mono text-[11px] font-semibold
                               text-accent whitespace-nowrap shadow-md">
